...
export default function DashboardHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 flex h-14 sm:h-16 items-center gap-4 border-b border-white/20 bg-white/40 px-4 backdrop-blur-xl sm:px-6 shadow-sm transition-all duration-300">
