      ...
      <div className="relative flex min-h-svh flex-1 flex-col bg-transparent">
        ...
        {hasPermission(currentUser, 'canAddDocument') && (
          <Button 
            ...
            className="fixed bottom-6 right-6 h-12 w-12 rounded-full bg-primary/80 hover:bg-primary/90 text-[#000066] shadow-2xl hover:shadow-xl transition-all duration-300 z-50 p-0 flex items-center justify-center"
            title={t('addDocument')}
          >
