...
export const COLUMN_CONFIG: { [key: string]: { name: string } } = {
    ...
    assignedDepartment: { name: 'Assigned Dept.' },
    label: { name: 'Label' },
