...
export const DEFAULT_LOGS: Log[] = [
    { id: 'log-1', docId: 'CON-001', oldStatus: 'Department B', newStatus: 'Department C', user: 'user@example.com', timestamp: '2025-07-16T10:05:00Z' },
    { id: 'log-2', docId: 'CON-001', oldStatus: 'Department A', newStatus: 'Department B', user: 'user@example.com', timestamp: '2025-07-16T09:30:00Z' },
    { id: 'log-3', docId: 'REQ-003', oldStatus: 'Department G', newStatus: 'Completed (Success)', user: 'user@example.com', timestamp: '2025-07-15T14:00:00Z' }
];
